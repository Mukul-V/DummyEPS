...
from epsapp.views.BaseRequestClass import get_data
...
class BaseView(APIView):
    ...
    def post(self, request):
        ...
        #     detail = post_data(model, data, "exception")
        ...
        if action == "null":  # this is also for Registration
            ...
            if model == "users":
                ...
                detail = post_data(org_id, user_id, auth_trail, model, data)  # function from BaseRequest Class
                return Response(detail)
